...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.12.20.tar.gz"
  sha256 "c2de0e6a7a3fe34fa80be706d642d78231b20cb76e52a4ed1f460a7e24923b37"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.12.20", shell_output("#{bin}/empirica --version")
