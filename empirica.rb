...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.12.21.tar.gz"
  sha256 "ba9b4467dd6cdf4047b8220ffe0a2793e426726d1fbdadf79f7f169b18efdbc7"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.12.21", shell_output("#{bin}/empirica --version")
